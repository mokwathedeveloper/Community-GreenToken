...
## 1. Core MVP Scope
- Define one killer feature for demo.
- Identify mandatory pages: Landing, Main Feature, Dashboard (optional), Token Redemption.
- Decide optional features: Leaderboard, Analytics, Donation Tracking.
